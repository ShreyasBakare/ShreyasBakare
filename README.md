...
A master's level physics student at the the [Indian Institute of Science Education and Research (IISER), Pune, India.](https://www.iiserpune.ac.in/) Currently, I'm in the final year of my BS-MS dual degree, working on masters thesis with the [Experimnetal Particle Physics group at IISER Pune.](http://sites.iiserpune.ac.in/~ehep/index.html)

## About Me

Hello! I’m fascinated by experimentally understanding the fundamental laws of nature. Particle physics experiments, in particular, present some exciting challenges that require a mix of sharp analytical thinking and computational creativity. 

I'm especially interested in exploring innovative ways to apply various machine learning techniques to make sense of the vast amounts of data generated by experiments like the [CMS experiment](https://cms.cern/detector) at the [Large Hadron Collider (LHC)](https://home.cern/science/accelerators/large-hadron-collider), [CERN.](https://home.cern/about)
